...
class TweetParser(object):
    '''
    This object can parse tweets and return information found within.
    '''

    def find_youtube_url(self, tweet):
        '''
    ...
    def find_mentions_with_youtubes(self, api):
        '''
        ...
        try:
            ...
            if len(mentions) > 0:
                ...
                for mention in mentions:
                    yubtub = self.find_youtube_url(mention)
